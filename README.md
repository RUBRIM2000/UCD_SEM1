...
Uit deze anthropometrische analyse en gebruikerstesten kunnen meerdere conclusies getrokken worden om het product te optimaliseren. Enerzijds is er beslist om de 'design for the tall' designstrategie toe te passen en een band van 26,43cm te laten leveren bij de 'professional' die deze dan op maat van de gebruiker zal afknippen. Hierdoor is het product voor 95% van de bevolking toegankelijk.
